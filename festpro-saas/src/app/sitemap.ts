...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = "https://festpro.app"

  return [
    { url: baseUrl, lastModified: new Date(), changeFrequency: "daily", priority: 1 },
    { url: `${baseUrl}/about`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/live`, lastModified: new Date(), changeFrequency: "always", priority: 0.9 },
    { url: `${baseUrl}/live/schedule`, lastModified: new Date(), changeFrequency: "hourly", priority: 0.8 },
    { url: `${baseUrl}/live/results`, lastModified: new Date(), changeFrequency: "hourly", priority: 0.8 },
    { url: `${baseUrl}/live/leaderboard`, lastModified: new Date(), changeFrequency: "hourly", priority: 0.7 },
    ...
    { url: `${baseUrl}/certificate`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
